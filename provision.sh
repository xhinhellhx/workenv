...
#
# Picked variables (the container engine and whether to install GUI apps) are
# remembered in a local state file (.provision.env, git-ignored), so later runs
# reuse them without prompting. Force a fresh pick with --reconfigure.
#
